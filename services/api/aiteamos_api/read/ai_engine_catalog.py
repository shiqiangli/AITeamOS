...
AI_ENGINE_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "claude-code": {
        ...
        "kind": "agent_platform",
        "description": "Claude Code-compatible local CLI RuntimeExecutor for governed coding sessions, inspect/report, and Ticket-bound repo mutation with approval.",
        "support_status": "supported",
        "auth_kind": "cli_login",
        "capabilities": ["coding_agent", "repo_edit", "mcp", "review", "runtime_executor", "compatible_local_cli", "deepseek_backend", "openai_backend"],
        "config_fields": [
            {"id": "command", "label": "Command", "kind": "text", "placeholder": "claude"},
            {"id": "model", "label": "Model", "kind": "text", "placeholder": "deepseek-reasoner"},
            {"id": "base_url", "label": "API base URL", "kind": "text", "placeholder": "https://api.deepseek.com"},
            {"id": "api_key_env", "label": "API key env", "kind": "text", "secret": True},
            {"id": "workspace", "label": "Workspace root", "kind": "text"},
        ],
    },
    "cursor": {
        "display_name": "Cursor",
        "kind": "agent_platform",
        "description": "Cursor commercial agent backend RuntimeExecutor for governed IDE-backed coding handoffs.",
        "support_status": "supported",
        "auth_kind": "bearer",
        "default_api_key_env": "CURSOR_API_KEY",
        "capabilities": ["coding_agent", "ide_context", "repo_edit", "runtime_executor", "commercial_agent_backend"],
        "config_fields": [
            {"id": "base_url", "label": "API base URL", "kind": "text", "placeholder": "https://cursor.example"},
            {"id": "api_key_env", "label": "API key env", "kind": "text", "secret": True},
            {"id": "model", "label": "Model", "kind": "text", "placeholder": "cursor-agent"},
            {"id": "workspace", "label": "Workspace root", "kind": "text"},
            {"id": "profile", "label": "Profile", "kind": "text"},
        ],
    },
    "openhands": {
        ...
        "kind": "agent_platform",
        "description": "OpenHands open-source RuntimeExecutor service for governed inspect/report and approved repo work.",
        "support_status": "supported",
        "auth_kind": "bearer",
        "default_api_key_env": "OPENHANDS_API_TOKEN",
        "capabilities": ["coding_agent", "repo_edit", "runtime_executor", "open_source_runtime"],
        "config_fields": [
            {"id": "base_url", "label": "API base URL", "kind": "text", "placeholder": "https://openhands.example"},
            {"id": "api_key_env", "label": "API key env", "kind": "text", "secret": True},
            {"id": "model", "label": "Model", "kind": "text", "placeholder": "deepseek-reasoner"},
            {"id": "workspace", "label": "Workspace root", "kind": "text"},
        ],
    ...
    "opencode": {
        ...
        "kind": "agent_platform",
        "description": "OpenCode-compatible local CLI RuntimeExecutor for lightweight governed coding handoffs.",
        "support_status": "supported",
        "auth_kind": "cli_login",
        "capabilities": ["coding_agent", "repo_edit", "runtime_executor", "open_source_runtime", "compatible_local_cli"],
        "config_fields": [
            {"id": "command", "label": "Command", "kind": "text", "placeholder": "opencode"},
            {"id": "model", "label": "Model", "kind": "text", "placeholder": "deepseek-reasoner"},
            {"id": "base_url", "label": "API base URL", "kind": "text", "placeholder": "https://api.deepseek.com"},
            {"id": "api_key_env", "label": "API key env", "kind": "text", "secret": True},
            {"id": "workspace", "label": "Workspace root", "kind": "text"},
